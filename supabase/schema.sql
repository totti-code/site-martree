...
values
  ...
  ('30000000-0000-0000-0000-000000000002', 'hero-secundario', 'Perecíveis frescos, açougue bem abastecido e conveniência para a rotina', 'Variedade com qualidade', 'Uma seleção pensada para atender compras residenciais e demandas do pequeno comércio local.', 'https://images.unsplash.com/photo-1604719312566-8912e9c8a213?auto=format&fit=crop&w=1400&q=80', 'Conhecer setores', '/servicos', 2, true)
on conflict (id) do nothing;
...
values
  ('40000000-0000-0000-0000-000000000001', 'home', 'destaques', 'Compra prática com categorias essenciais bem organizadas', 'Destaques da loja', 'A loja foi pensada para facilitar a jornada do cliente, com circulação clara, exposição objetiva e reposição frequente.', 'Açougue e carnes frescas\nHortifruti selecionado\nPadaria para o dia a dia\nLimpeza, higiene e utilidades', null, 'Ver setores', '/servicos', 1, true),
